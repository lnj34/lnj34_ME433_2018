 ...
 * Author: jidingzi
 *
 * Created on April 24, 2018, 2:45 PM
 */
...
void LCD_drawXBar(unsigned short, unsigned short, unsigned short, unsigned short, unsigned short, unsigned short);
void LCD_drawYBar(unsigned short, unsigned short, unsigned short, unsigned short, unsigned short, unsigned short);
